...
public class AdminServlet extends HttpServlet
{
  ...
  {
	  com.prolaborate.configureui.ConfigResource.log.info("AdminServlet Initiated"+"\n");
	
	  this.userManager = userManager;
	  this.loginUriProvider = loginUriProvider;
	  this.renderer = renderer;
	  com.prolaborate.configureui.ConfigResource.log.info("logger message on Admin servlet page.");
  }
